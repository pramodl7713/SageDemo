...
public class Xls_Reader {
	...
	public void initializeExcel(String sheet_Name, int rownumber) {
		this.sheet_Name = sheet_Name;
		this.rownumber = rownumber;

	}

	public String getCellData2(String colName) {
		try {
			if (rownumber <= 0)
				return "";
			...
			e.printStackTrace();
			return "row " + rownumber + " or column " + colName + " does not exist in xlsx";
		}
	}

//************************ SET CELL FOR APPLYING COLOR******************************************
